...
//    List file    =  
//        C:\Users\THINK\Documents\GitHub\FTT-TwoLine-Operater\STM8L051\Project\main_code\EWSTM8\STM8L05X_LD_VL(STM8L05xx3)\List\stm8l15x_clk.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  703       CLK->PCKENR2 |= (uint8_t)((uint8_t)1 << ((uint8_t)CLK_Peripheral & (uint8_t)0x0F));
        LD        A, S:?b1
        OR        A, L:0x50c4
        JRA       L:??CLK_PeripheralClockConfig_5
//  704     }
//  705     else
//  706     {
...
//  716       CLK->PCKENR3 |= (uint8_t)((uint8_t)1 << ((uint8_t)CLK_Peripheral & (uint8_t)0x0F));
        LD        A, S:?b1
        OR        A, L:0x50d0
        JRA       L:??CLK_PeripheralClockConfig_7
//  717     }
//  718     else
//  719     {
...
// 612 bytes in section .near_func.text
// 
